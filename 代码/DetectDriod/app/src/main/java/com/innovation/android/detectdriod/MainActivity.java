...
import com.innovation.android.detectdriod.R;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listview = (ListView) findViewById(R.id.listviewApp);//listviewApp是browse_app_list中的ListView布局
        if (getIntent() != null) {
            filter = getIntent().getIntExtra("filter", 0);
        }
        mlistAppInfo = queryFilterAppInfo(filter); // 查询所有应用程序信息
        //mlistAppInfo里边存放的是AppInfo类型的数据，每个appInfo中包含应用程序的基本信息。
        // 构建适配器，并且注册到listView
        ...
        listview.setOnItemClickListener(new OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int position,long arg3){
                ...
                //我需要在这里根据item的position，获取相应的应用程序的信息，将包名传到另外一个intent
                Intent intent = new Intent(getApplicationContext(),ShowPermission.class);
